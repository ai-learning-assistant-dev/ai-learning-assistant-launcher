...
export type ActionName = 'query' | 'install' | 'update';
...
const manifestSample = {
  ...
  description:
    "Highlight and speak text from your notes. Converts text to speech in real-time using lifelike voices from OpenAI. Development fork by AI Learning Assistant based on Adrian Lyjak's work.",
  author: "AI Learning Assistant Dev (based on Adrian Lyjak's work)",
  authorUrl: 'https://github.com/ai-learning-assistant-dev',
  fundingUrl: {
    'GitHub Repository':
      'https://github.com/ai-learning-assistant-dev/obsidian-aloud-tts',
