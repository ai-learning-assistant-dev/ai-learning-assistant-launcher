...
import type { ImageInfo, PodmanListImagesOptions } from './image-info';
...
export class LibpodDockerode {
  ...
  enhancePrototypeWithLibPod(): void {
    const prototypeOfDockerode =
      Dockerode.prototype as any as DockerodeInternals;
    ...
    prototypeOfDockerode.listPodmanContainers = function (opts?: {
      ...
      return new Promise((resolve, reject) => {
        this.modem.dial(optsf, (err: any, data: any) => {
          if (err) {
            return reject(err);
          }
    ...
    prototypeOfDockerode.podmanAttach = function (
      ...
      return new Promise((resolve, reject) => {
        this.modem.dial(optsf, (err: any, stream: any) => {
          if (err) {
            return reject(err);
          }
